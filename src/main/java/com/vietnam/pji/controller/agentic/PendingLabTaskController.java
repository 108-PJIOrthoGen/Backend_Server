...
@Tag(name = "Pending Lab Tasks", description = "Lab data follow-up tasks generated by AI completeness checks")
@RequiredArgsConstructor
public class PendingLabTaskController {

    private final PendingLabTaskService pendingLabTaskService;

    @Operation(summary = "My pending tasks", description = "Returns pending lab tasks assigned to the current user")
    ...
    @Operation(summary = "My pending task count")
    ...
    @Operation(summary = "Dismiss task", description = "Marks a pending task as dismissed without entering data")
